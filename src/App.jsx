    ...
    <>
      <div className='relative'>
        ...
        <div className="absolute w-60 m-3 px-3 py-5 bg-white top-0">
          ...
          <p>Data: <a className='text-blue-500' href='https://data.cityofnewyork.us/Public-Safety/NYPD-Motor-Vehicle-Collisions/h9gi-nx95'>Motor vehicle collision injuries and deaths</a> in NYC, Jan 2016</p>
          ...
          <div className='session' id='sliderbar'>
            <h2>Hour: <label id='active-hour'>{formatHour(hour)}</label></h2>
            <input id='slider' className='row' onChange={handleSliderChange} type='range' min='0' max='23' step='1' value={hour} />
          </div>
        </div>
      </div>
    </>
